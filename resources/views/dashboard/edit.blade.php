            ...
            <div class="content container-fluid">
               ...
               <div class="row">
                  <div class="col-sm-12">
                     <div class="card">
                        <div class="card-body">
                           <form action="{{route('update', $tplan->id)}}" method="POST" >
                            @csrf
                            @method('put')
                              <div class="row">
                                 <div class="col-12">
                           ...
                           @enderror
                                 <div class="col-12 col-sm-6">
                                    <div class="form-group">
                                       <label>DAY</label>
                                       <div>
                                          <input type="date" class="form-control" name="day" value="{{$tplan->day}}">
                                       </div>
                                    </div>
                                 ...
                                 <div class="col-12 col-sm-6">
                                    ...
                                    <div class="form-group">
                                       ...
                                       <div>
                                          <input type="date" class="form-control" name="week_end_date" value="{{$tplan->week_end_date}}">
                                       </div>
                                    </div>
                                 ...
                                 <div class="col-12 col-sm-6">
                                    <div class="form-group">
                                       ...
                                       <div>
                                          <input type="text" class="form-control" name="general_topic" value="{{$tplan->general_topic}}" >
                                       </div>
                                    </div>
                                 </div>
